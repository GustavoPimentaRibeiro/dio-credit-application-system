...
class CustomerResourceTest {
    ...
    @BeforeEach fun setup() = customerRepository.deleteAll() // deleta todos os dados antes de executar
    @AfterEach fun tearDown() = customerRepository.deleteAll() // deleta todos os dados depois de executar

    @Test
    fun `should create a customer and return 201 status`() {
        // given
        val customerDto: CustomerDto = buildCustomerDto()
        val valueAsString: String = objectMapper.writeValueAsString(customerDto) // Transforma em string todos os campos
    ...
    @Test
    fun `should not save a customer with lastName empty and return 400 status`() {
        // given
        val customerDto: CustomerDto = buildCustomerDto(lastName = "")
        val valueAsString: String = objectMapper.writeValueAsString(customerDto)
    ...
    @Test
    fun `should not save a customer with password empty and return 400 status`() {
        // given
        val customerDto: CustomerDto = buildCustomerDto(password = "")
        val valueAsString: String = objectMapper.writeValueAsString(customerDto)
    ...
    @Test
    fun `should not save a customer with zipCode empty and return 400 status`() {
        // given
        val customerDto: CustomerDto = buildCustomerDto(zipCode = "")
        val valueAsString: String = objectMapper.writeValueAsString(customerDto)
    ...
    @Test
    fun `should not save a customer with street empty and return 400 status`() {
        // given
        val customerDto: CustomerDto = buildCustomerDto(street = "")
        val valueAsString: String = objectMapper.writeValueAsString(customerDto)
    ...
    @Test
    fun `should update a costumer and return 200 status`() {
        // given
        val customer: Customer = customerRepository.save(buildCustomerDto().toEntity())
    ...
    @Test
    fun `should not  update a costumer with invalid id and return 400 status`() {
        // given
